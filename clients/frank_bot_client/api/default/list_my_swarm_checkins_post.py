...
from ...models.swarm_my_checkins_request import SwarmMyCheckinsRequest
...
def sync_detailed(
    *,
    ...
    """List recent Swarm check-ins for your account via JSON body.
