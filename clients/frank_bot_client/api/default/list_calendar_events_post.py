...
from ...models.list_calendar_events_request import ListCalendarEventsRequest
...
def _get_kwargs(
    *,
    body: ListCalendarEventsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/actions/calendar/events:list",
    }
...
def sync_detailed(
    *,
    ...
    """List calendar events via JSON body.
